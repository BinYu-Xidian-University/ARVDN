...
define p1:module_spec_init=1;
define p2:module_spec_load=1;
define p3:module_spec_compress=1;
define p4:module_spec_reset=1;
define p5:module_spec_rewind=1;
define p6:module_spec_uncompress=1;
som((p1;p2;(p3;p4;p5;p6)#)#)
/>
frame(temp_i,temp_j,syf,bytesIn,bytesOut,verbosity,keepInputFiles,smallMode,testFailsExist,globalCrc,numFileNames,numFilesProcessed,opMode,srcMode,longestFileName,inName,outName,progName,progNameReally,outputHandleJustInCase,block,quadrant,zptr,szptr,ftab,ll16,ll4,tt,ll8,unzftab,last,origPtr,blockSize100k,workFactor,workDone,workLimit,blockRandomised,firstAttempt,nBlocksRandomised,inUse,nInUse,seqToUnseq,unseqToSeq,selector,selectorMtf,nMTF,mtfFreq,len$,limit,base,perm,minLens,code,rfreq,crc32Table,bsBuff,bsLive,bsStream,bsWriting,incs,rNums,dbglvl,spec_fd,seedi,main_level,module_spec_init,module_spec_load,module_spec_compress,module_spec_reset,module_spec_rewind,module_spec_uncompress) and (
 int module_spec_init<==0 and skip;
 int module_spec_load<==0 and skip;
 int module_spec_compress<==0 and skip;
 int module_spec_reset<==0 and skip;
 int module_spec_rewind<==0 and skip;
 int module_spec_uncompress<==0 and skip;
 int syf<==0 and skip;
 ...
 {
     frame(loop,main_i,main_input_size,main_compressed_size,main_input_name,main_validate_array,return) and (
	 int loop<==1 and skip;
	 while(loop < 100)
	 {
		loop:=loop+1;
 ...
 {
	 module_spec_compress<==1 and skip;
     blockSize100k:=lev;
 ...
 {
	module_spec_uncompress<==1 and skip;
     blockSize100k:=0;
